...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/dist/plugins/select2/select2.min.css')); ?>">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper" id="app">
        ...
        <?php echo $__env->make('layouts.sidebaradmin', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php elseif(auth()->user()->role_id==5): ?>
        <?php echo $__env->make('layouts.sidebarstoreuser', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php elseif(auth()->user()->role_id==6): ?>
        <?php echo $__env->make('layouts.sidebarmms', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php elseif(auth()->user()->role_id==2): ?>
        <?php echo $__env->make('layouts.sidebarmms', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php elseif(auth()->user()->role_id==4): ?>
        <?php echo $__env->make('layouts.sidebarfinance', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>    
        <?php else: ?>
    ...
    <script src="<?php echo e(asset('/dist/plugins/select2/select2.full.min.js')); ?>"></script>
  ...
  <script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script>
    ...
    function getuserdatafun() {
        ...
        $.ajax({
            url: '<?php echo e(url(' / getuserdata ')); ?>',
            type: 'POST',
