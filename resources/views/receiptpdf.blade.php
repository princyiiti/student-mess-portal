    ...
    <table class="waffle" style="width:90%"  cellspacing="0" cellpadding="0">
        <tbody>
            <tr style="height: 23px">
                ...
                <img src="{{asset('/iit_image.png')}}" height="100%" width="100%"  />
                </div>
                </td>
            ...
            <tr style="height: 27px">
                ...
                <td class="s2" colspan="6">FEE RECEIPT ( {{$totalamount->academic_tearm}} {{$totalamount->academic_year}})</td>
            </tr>
            <tr style="height: 21px">
               
                <td class="s3">RECEIPT NO.</td>
                <td class="s4">{{$totalamount->rollno}}</td>
                <td class="s3" colspan="2">DATE</td>
                <td class="s4" colspan="2">{{now()->format('d-m-Y')}}</td>
            </tr>
            <tr style="height: 22px">
              
                <td class="s5">ROLL NO.</td>
                <td class="s6">{{$totalamount->rollno}}</td>
                <td class="s5" colspan="2">COURSE</td>
                <td class="s6" colspan="2">{{$totalamount->program}}</td>
            </tr>
            <tr style="height: 32px">
              
                <td class="s7">NAME</td>
                <td class="s8" colspan="5">{{$totalamount->student_name}}</td>
            </tr>
            <tr style="height: 23px">
                
                <td class="s9">CATEGORY</td>
                <td class="s9">{{$totalamount->category}}</td>
                <td class="s10" colspan="2">DEPARTMENT</td>
                <td class="s10" colspan="2">{{$studentprofile->dept}}</td>
            </tr>
            ...
            @foreach($totalamount->Feestructuredata->FeeDetails as $index => $list)
            <tr style="height: 21px">
               
                <td class="s4">{{$index +1}}</td>
                <td class="s13" colspan="3">{{$list->fee_type}}</td>
                <td class="s14" colspan="2">{{$list->amount}} </td>
            </tr>
            @endforeach
            ...
            <tr style="height: 22px">
                ...
                <td class="s18" colspan="2"> {{$totalamount->totalamount}} </td>
            </tr>
            @if($totalamount->remission_amount!='')
            <tr style="height: 21px">
               
                <td class="s13" colspan="4">Less: Remission 
                    @if($totalamount->remissiontype=='1/3')
                2/3 
                @else
                 {{$totalamount->remissiontype}}
                 @endif
            Tuition Fee </td>
                <td class="s14" colspan="2">{{$totalamount->remission_amount}} </td>
            </tr>
            @endif
            <tr style="height: 22px">
                ...
                <td class="s15" colspan="4">TOTAL FEE RECEIVABLE</td>
                  @if($totalamount->remission_amount!='')
                <td class="s16" colspan="2"> {{$totalamount->totalamount-$totalamount->remission_amount}} </td>
                @else
                <td class="s16" colspan="2"> {{$totalamount->totalamount}} </td>
                @endif
            ...
            <tr style="height: 22px">
                ...
                <td class="s17" colspan="4">FEE RECEIVED</td>
                  @if($totalamount->remission_amount!='')
                <td class="s18" colspan="2"> {{$totalamount->totalamount-$totalamount->remission_amount}} </td>
                @else
                 <td class="s18" colspan="2"> {{$totalamount->totalamount}} </td>
                 @endif
            </tr>
            <tr style="height: 44px">
                ...
                <td class="s20" colspan="5">{{$word}}</td>
            </tr>
            <tr style="height: 22px">
            ...
            <tr style="height: 38px">
                ...
                <td class="s22">{{$totalamount->transaction_id}}</td>
                <td class="s13" colspan="2">DD/TRANSACTION DATE</td>
                <td class="s23" colspan="2">{{$totalamount->paid_date}}</td>
            </tr>
            <tr style="height: 21px">
                ...
                @if($totalamount->remission_amount!='')
                <td class="s24" colspan="2" rowspan="2"> {{$totalamount->totalamount-$totalamount->remission_amount}}</td>
                @else
                 <td class="s24" colspan="2" rowspan="2"> {{$totalamount->totalamount}}</td>
                 @endif
            </tr>
            <tr style="height: 22px">
