...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="{{asset('Front/assets/css/bootstrap.min.css')}}"></link>
    <!-- <link rel="stylesheet" href="./webfront/assets/css/bootstrap.min.css"> -->
    <link rel="stylesheet" href="{{asset('Front/webfront/assets/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('Front/webfront/assets/css/slicknav.css')}}">
                    ...
                    <div class="col-md-6 ">
                        <div class="single-services mb-30">
                          ...
                          <div class="features-caption">
                                ...
                                <p><a href="{{ url('/redirect') }}" class="btn btn-block btn-primary">Click Here login with  institute email id </a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
