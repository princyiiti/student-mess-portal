...
<div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form id="myform1" method="POST" action="{{ url('/admin/rebate/' . $category->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('admin.Slot.form', ['formMode' => 'edit'])
