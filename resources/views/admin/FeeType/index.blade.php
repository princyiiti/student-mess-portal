...
<div class="card card-primary">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/feetype/create') }}" class="btn btn-success btn-sm" title="Add New Role">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/admin/feetype') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                            <div class="input-group">
                                ...
                                <span class="input-group-append">
                                <a  href ="{{ url('/admin/feetype') }}" class="btn btn-secondary" id="refresh">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($FeeType as $item)
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <a href="{{ url('admin/feetype/' . $item->id . '/edit') }}" title="Edit Role"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                            ...
                            <div class="pagination-wrapper"> {!! $FeeType->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
