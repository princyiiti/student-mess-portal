                                                    ...
                                                    <tr>
                                                        <td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;"
                                                            ...
                                                            <h4 class="text"
                                                                ...
                                                                Your Rebate Request Has Been @if($Rebate->status == 1) Approved! @else Rejected @endif</h4>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <ul>
                                                                                <li style="font-size: smaller;font-weight: 400;">
                                                                                    Rebate From Date:  &nbsp;&nbsp; {{ $Rebate->from_date}}</li>
                                                                                <li
                                                                                style="font-size: smaller;font-weight: 400;">
                                                                                    Rebate End Date &nbsp;&nbsp; {{ $Rebate->to_date}}
                                                                                </li>
                                                                                <li
                                                                                style="font-size: smaller;font-weight: 400;">
                                                                                    Total Days &nbsp;&nbsp; {{ $Rebate->total_rebate_day}}</li>
                                                                                    <li
                                                                                style="font-size: smaller;font-weight: 400;">
                                                                                Caterer Name &nbsp;&nbsp; {{ $Rebate->mess_name}}</li>
                                                                                    <li
                                                                                style="font-size: smaller;font-weight: 400;">
                                                                                    Status &nbsp;&nbsp; 
                                                                                    @if($Rebate->status == 1)
