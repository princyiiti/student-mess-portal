...
<tr>
    <td style="padding: 30px; line-height: 30px"> Dear Mr./Ms. <b>{{$model->name}}</b>
        <br>Kindly be informed that your  Fee Amount  has received . <br>
      
       </b><br>
        
    <br>
    If you have any questions, please don't hesitate to contact us at fas@iiti.ac.in
...
Regards</p>
<h2 style="color: #157abe; font-size: 18px;">
...
System Gerated Mail Please do not reply to this mail. For further assistance, please contact us at fas@iiti.ac.in
</td>
</tr>
</table>
