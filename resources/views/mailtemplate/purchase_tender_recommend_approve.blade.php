            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" align="center" width="100%">
                        ...
                        <tr>
                            <td style="padding: 30px; line-height: 30px">Dear Mr./Mrs. <b>{{$model->recommended->name}}</b>
                                <br> 
A Purchase Indent has been filled by Indentor=> Mr./Mrs.{{$model->indentor->name}} and He is Waiting for your Recommendation
                                <br>
                                for further details Please visit <a href="http://erp.iiti.ac.in/">http://erp.iiti.ac.in/</a>
                              <div style="text-align: center; padding: 20px"> <a class="button" style=" background-color: #4CAF50;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;" href="{{ url('/activationpurchaseindentrecommending/' . $model->active_code) }}">Click here for Recommended </a>
