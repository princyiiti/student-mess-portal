                    ...
                    <table cellpadding="0" cellspacing="0" align="center" width="100%">
                        ...
                        <tr>
                            <td style="padding: 30px; line-height: 30px">Dear Mr./Mrs. <b>{{$model->indentor->name}}</b>
                                <br> This is with reserance indent No. {{ $model->finance_year.'/'. $model->indent_number }}  Indentor=> Mr./Mrs.{{$model->indentor->name}}  Your Purchase Indent Budget Allotted,<br>
