                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: block;">
                            <li class="nav-item">
                                <a href="{{ url('/admin/courseregiration') }}" class="nav-link {{ request()->path() === 'admin/courseregiration' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text">Program wise Course List </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('electivelist') }}" class="nav-link {{  request()->path()=='electivelist' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text">All Elective List</p>
                                </a>
                            </li>
                              <li class="nav-item">
                                <a href="{{ url('newstudentregistration') }}" class="nav-link {{ request()->path() =='newstudentregistration' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text">New Student in the AROL</p>
                                </a>
                            </li>
                                <li class="nav-item">
                                <a href="{{ url('newusercreateform') }}" class="nav-link {{ request()->path() =='newstudentregistration' ? 'active' : '' }} ">
                                    <i class="far fa-circle nav-icon"></i>
